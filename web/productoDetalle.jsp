                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-50" src="ic_producto.png" style="width: 100px;height: 300px;" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-50" src="ic_producto.png" style="width: 100px;height: 300px;" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-50" src="ic_producto.png" style="width: 100px;height: 300px;" alt="Third slide">
                        </div>
                    </div>
